...
public class SurveyTest {
	 ...
	 */
	@Test
	public void testGetNextQuestionWhereAnswerYes() throws Exception {
		Question question = survey.getNextQuestion();
		question.getResponse().setAnswer("YES");
		
		assertThat(question.toString(), CoreMatchers.allOf(CoreMatchers.containsString("id=Q1"),
	 ...
	 */
	@Test
	public void testGetNextQuestionWhereAnswerNo() throws Exception {
		Question question = survey.getNextQuestion();
		question.getResponse().setAnswer("NO");
