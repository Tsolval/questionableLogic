...
public class QLService {
	...
	public List<Question> getQuestions(String questionGroup) {
		...
		Question q1 = new Question("Is this a question?", ResponseType.BOOLEAN);
		Question q2 = new Question("You're right! How does that make you feel?", ResponseType.TEXTBOX,
				new Conditional(q1, "YES"));
		Question q3 = new Question("Of course it's a question! How could you get that wrong!?", ResponseType.TEXTAREA,
